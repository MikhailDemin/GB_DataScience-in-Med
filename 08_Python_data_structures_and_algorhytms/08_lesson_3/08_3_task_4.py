...
# В цикле for in будем сравнивать количество повторений с максимальным количеством повторов элемента. Если количество
# текущего элемента больше максимального, тогда переменной max_freq присваивается значение повторов текущего элемента:
num = array[0]
max_freq = 1
