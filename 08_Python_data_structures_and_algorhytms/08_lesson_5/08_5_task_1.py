...
# Добрый вечер.
#
# В задании указано "прибыль за четыре квартала для каждого предприятия". У вас только годовая.
# "Отдельно вывести наименования предприятий, чья прибыль выше среднего и ниже среднего". Здесь задание подразумевает
# составление 2-х списков: с прибылью ниже и с прибылью выше среднего. Либо вывод на экран таких предприятий
# в одной группе.
