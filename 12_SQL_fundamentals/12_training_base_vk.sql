...
CREATE TABLE users (
	...
	phone BIGINT UNSIGNED UNIQUE COMMENT '“елефон', -- +7(999) 123-45-67 => 79 991 234 567
	
	INDEX idx_firstname_lastname(firstname, lastname)
) COMMENT 'ѕользователи';

-- 1 x 1
DROP TABLE IF EXISTS profiles;
CREATE TABLE profiles (
	user_id BIGINT UNSIGNED NOT NULL PRIMARY KEY,
	gender CHAR(1) COMMENT 'ѕол',
	hometown VARCHAR(200) COMMENT '–одной город',
