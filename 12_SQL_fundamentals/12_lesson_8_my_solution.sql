...
Здорово, что придерживаетесь принятого в SQL стиля оформления кода (зарезервированные слова в верхнем регистре,
форматирование кода)!
В материалах к уроку 10 есть разбор этого ДЗ со сравнением решения с вложенными запросами и с использованием JOIN.
*/