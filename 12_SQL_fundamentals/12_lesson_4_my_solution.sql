...
-- в таблице медиа это контент который генер€т сами пользователи,
...
/*  омментарии преподавател€:
 ирилл »ванов?ѕреподаватель
ƒл€ индексов, так же, как и дл€ внешних ключей можно (но не об€зательно) задавать имена при их определении.
ѕравильно, что используете механизм установки значени€ полей по умолчанию (DEFAULT).
ѕравильно, что используете механизм автообновлени€ значени€ пол€ при операции UPDATE.
*/
